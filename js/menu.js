var Menu = (function () {
    var $container = $('#rm-container'),
        ...
        $details = $container.find('a.rm-viewdetails'), init = function () {
            initEvents();
        },
        initEvents = function () {
        ...
        viewDetails = function (recipe) {
            ...
            var $modal = $('<div class="rm-modal">' +
                '<div class="rm-thumb" ' +
                'style="background-image: url(' + img + ')"></div><h5>' + title + '</h5><p>' + description + '</p><a href="' + url + '">' +
                '看看详情</a>' +
